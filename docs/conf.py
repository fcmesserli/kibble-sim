...
from moving_mode import error_sim
...
project = 'Kibble-Sim'
copyright = '\xa9 2023, Measurement Standards Laboratory of New Zealand'
...
htmlhelp_basename = 'Kibble-Simdoc'
...
latex_documents = [
    (master_doc, 'Kibble-Sim.tex', 'Kibble-Sim Documentation',
...
man_pages = [
    (master_doc, 'Kibble-Sim', 'Kibble-Sim Documentation',
     [author], 1)
]
